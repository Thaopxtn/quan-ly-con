              ...
              <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-2xs space-y-3">
                ...
                <div className="flex items-center justify-between text-xs text-slate-600 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Mã nguồn dự án trên GitHub:</span>
                  </div>
                  <a
                    href="https://github.com/Thaopxtn/quan-ly-con"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-bold text-blue-600 hover:text-blue-800 flex items-center gap-1 hover:underline cursor-pointer"
                  >
                    <span>Thaopxtn/quan-ly-con</span>
