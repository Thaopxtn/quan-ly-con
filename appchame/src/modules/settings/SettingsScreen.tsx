    ...
    <div className="flex-1 flex flex-col bg-slate-50 select-none pb-6">
      ...
      <div className="flex-1 p-4 space-y-3 overflow-y-auto">
        <div className="bg-white rounded-2xl p-2 border border-slate-100 shadow-soft divide-y divide-slate-100">
          ...
          {/* Mã nguồn mở GitHub */}
          <a
            href="https://github.com/Thaopxtn/quan-ly-con"
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 flex items-center justify-between hover:bg-slate-50/80 rounded-xl cursor-pointer transition text-inherit no-underline"
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xs font-bold text-slate-800 flex items-center gap-1.5">
                  Mã Nguồn GitHub (Thaopxtn)
                  <span className="text-[9px] font-extrabold px-1.5 py-0.2 rounded-full bg-slate-100 text-slate-600">Open Source</span>
                </span>
                <span className="text-[10px] text-slate-400">Kho lưu trữ & tài liệu dự án trên GitHub</span>
              </div>
            </div>
