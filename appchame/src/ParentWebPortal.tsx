      ...
      <aside className="w-72 bg-white border-r border-slate-200 flex flex-col shrink-0 shadow-xs z-30">
        ...
        <div className="p-3.5 border-t border-slate-100 bg-slate-50/70 space-y-2">
          ...
          <a
            ...
            className="w-full py-1.5 px-2 bg-slate-900 hover:bg-black text-white rounded-xl text-[10px] font-bold flex items-center justify-center space-x-1.5 transition shadow-xs cursor-pointer"
            title="Xem mã nguồn mở & tài liệu kỹ thuật trên GitHub"
          >
            ...
            <span>Mã Nguồn GitHub (Thaopxtn)</span>
        ...
        <header className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 shadow-2xs z-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <a
              ...
              title="Mã nguồn GitHub dự án: https://github.com/Thaopxtn/quan-ly-con"
            >
